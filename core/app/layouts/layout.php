    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="./" class="logo">
          ...
          <span class="logo-mini">P<b>SV</b></span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg">PAPELERIA<b>SV</b></span>
        </a>
...
<div class="user-panel">
          ...
          <ul class="sidebar-menu">
            ...
            <li><a href="./?view=sell"><i class='fa fa-cube'></i> <span>Caja</span></a></li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="./?view=products">Listado</a></li>
            ...
            <li class="treeview">
              <a href="#"><i class='fa fa-area-chart'></i> <span>Almacen</span> <i class="fa fa-angle-left pull-right"></i></a>
              <ul class="treeview-menu">
            ...
            <?php else: ?>
            <li><a href="./?view=inventary"><i class='fa fa-area-chart'></i> <span>Inventario</span></a></li>
            <?php endif; ?>
