...
class OperationData {
	...
	public function add(){
		$sql = "insert into ".self::$tablename." (product_id,q,price,operation_type_id,sell_id,created_at) ";
		$sql .= "value (\"$this->product_id\",\"$this->q\",\"$this->price\",$this->operation_type_id,$this->sell_id,$this->created_at)";
