...
<?php foreach($operations as $operation):?>
	<tr>
		...
		<td><?php echo number_format($operation->total-$operation->discount,2,'.',','); ?> Bs</td>
	</tr>
<?php
...
<h1>Total de ventas: <?php echo number_format($supertotal,2,'.',','); ?> Bs</h1>
...
<!-- Se ha agregado este codigo javascript para validar las fechas -->
<script>
  $(document).ready(function(){
  $("#formSellReport").submit(function(e) {
  	var sd = $("#sd").val();
  	var ed = $("#ed").val();

  	if ((Date.parse(sd) > Date.parse(ed)) || sd=="" || ed=="")  {
