...
<div class="row">
	<div class="col-md-12">
		<div class="btn-group  pull-right">
			<a href="index.php?view=newproduct" class="btn btn-default"><i class='fa fa-glass'></i> Agregar Producto</a>
			...
			<div class="btn-group pull-right">
	    		...
	    		<i class="fa fa-download"></i> Descargar <span class="caret"></span>
	  			...
	  			<ul class="dropdown-menu" role="menu">
	    			<li><a href="report/products-word.php">Word (.docx)</a></li>
	  			</ul>
			</div>
			<?php }?>
	</div>
...
<table class="table table-bordered table-hover">
	...
	<tr>
		...
		<td><?php echo number_format($product->price_in,2,'.',','); ?> Bs</td>
		<td><?php echo number_format($product->price_out,2,'.',','); ?> Bs</td>
