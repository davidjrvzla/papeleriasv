...
if(count($products)>0){
	...
	if($page==1){
		...
		$curr_products = SellData::getAllSellsByPage($products[0]->id,$limit);
		...
		$curr_products = SellData::getAllSellsByPage($products[($page-1)*$limit]->id,$limit);
	}
...
<table class="table table-bordered table-hover	">
	...
	<tr>
		...
		<td style="width:30px;"><a href="index.php?view=delsell&id=<?php echo $sell->id; ?>" class="btn btn-xs btn-danger"><i class="fa fa-trash"></i></a>
		</td>
		<?php endif; ?>
		<!--Eliminar-->
	</tr>
...
<!-- Fin de controles -->
	...
	echo "<p class='alert alert-danger'>No hay Ventas</p>";
}
