...
$q= OperationData::getQYesF($product->id);
	...
	<tr class="<?php if($q<=$product->inventary_min){ echo "danger"; }?>">
		...
		<td><b><?php echo number_format($product->price_out,2,'.',','); ?> Bs</b></td>
		<td>
			<?php echo $q; ?>
		</td>
		<td style="width:250px;"><form method="post" action="index.php?view=addtocart">
		<input type="hidden" name="product_id" value="<?php echo $product->id; ?>">
		<input type="hidden" name="price" value="<?php echo $product->price_out; ?>">

<div class="input-group">
		<input type="number" min="1" max="<?php echo $q; ?>" class="form-control" required name="q" placeholder="Cantidad">
