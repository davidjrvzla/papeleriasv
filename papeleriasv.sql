...
insert into user(name,lastname,username,email,password,is_active,is_admin,created_at) value ("Administrador", "Papeleria", "admin", "admin@gmail.com","90b9aa7e25f80cf4f64e990b78a9fc5ebd6cecad",1,1,NOW());
...
insert into configuration(short,name,kind,val) value("title","Titulo del Sistema",2,"Papeleria San Vicente");
