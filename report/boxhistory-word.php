...
$table1->addRow();
$table1->addCell(5000)->addText(number_format($total,2,".",",")." Bs");
$table1->addCell(2500)->addText($box->created_at);

}
$section1->addText("");
$section1->addText("Total: ".number_format($total_total,2,".",",")." Bs",array("size"=>22));
$word->addTableStyle('table1', $styleTable,$styleFirstRow);
/// datos bancarios

$filename = "Historial_Caja-".time().".docx";
